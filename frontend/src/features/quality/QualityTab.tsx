    ...
    <div className="q">
      <header className="q-head">
        ...
        <p className="q-intro muted">
          Как проверяли: модель «прогнозировала» прошлые месяцы так же, как февраль — только по прогнозам погоды, известным
          на тот момент, — и мы сравнили прогноз с тем, что станция выработала на самом деле. Ошибка — насколько в среднем
          прогноз промахивается, в % от максимальной мощности: чем меньше, тем лучше. Факта за февраль 2026 нет, поэтому
          проверка на прошлых месяцах.
        </p>
      </header>
              ...
              <Card
                ...
                title={
                  <span className="q-title-icon">
                    <Target size={16} aria-hidden /> Можно ли верить вероятному диапазону
                  </span>
                }
              >
                <CoverageBlock
