...
export default function StationsTab({ theme }: { theme: Theme }) {
  ...
  return (
    <div className="st">
      ...
      <Notice tone="info">
        <b>Раздел для масштабирования</b> — задел на парк станций владельца: добавить свои станции и турбины, загрузить их
        историю и получить прогноз. Станция из ТЗ — полная модель (вкладка «Прогноз»). Новые станции — упрощённая: кривая
        мощности по истории + погода Open-Meteo, без агентного цикла.
      </Notice>
