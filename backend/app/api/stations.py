...
и привязывает историю к турбине. Помесячная загрузка с автоматическим пересчётом упрощённой модели станции (кривая мощности)
и прогнозом на 48 ч — в app/api/station_model.py; полная модель — только для станции кейса.
"""
